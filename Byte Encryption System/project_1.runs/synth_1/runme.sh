...
HD_PWD='C:/Users/zhiyua15/Downloads/Final_lab1_AD_ZL.xpr/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encryption_system.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encryption_system.tcl
