...
HD_PWD='C:/Users/zhiyua15/Downloads/Final_lab1_AD_ZL.xpr/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encryption_system.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encryption_system.tcl -notrace
